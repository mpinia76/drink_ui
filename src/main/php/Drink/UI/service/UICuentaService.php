<?php
namespace Drink\UI\service;

use Drink\UI\components\filter\model\UICuentaCriteria;
...
use Drink\Core\model\Transferencia;
...
class UICuentaService {
	...
	public function getCajaChica(){
		...
		try {
			...
			return DrinkUtils::getCuentaUnica();
	...
	public function getCuentaBAPRO(){
		...
		try {
			...
			return DrinkUtils::getCuentaBAPRO();
