 ...
 * @since 30/08/2019
 */
class ComboFinder implements  IAutocompleteFinder {
	...
	public function findEntitiesByText( $text, $parent=null ){
		...
		return UIServiceFactory::getUIComboService()->getList($uiCriteria);	
	}
	...
	function findEntityByCode( $code, $parent=null ){
		...
		return UIServiceFactory::getUIComboService()->get( $code );
	}
