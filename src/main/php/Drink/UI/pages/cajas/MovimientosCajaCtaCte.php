<?php
namespace Drink\UI\pages\cajas;
...
use Drink\UI\components\grid\model\MovimientoCajaCtaCteGridModel;
 ...
 * 
 */
class MovimientosCajaCtaCte extends DrinkPage{
	...
	public function getTitle(){
		return $this->localize( "cajaCtaCte.movimientos.title" );
	}
...
//		$menuGroup->addMenuOption( $menuOption );
	...
	public function getType(){
		...
		return "MovimientosCajaCtaCte";
		
	}	

	public function getModelClazz(){
		return get_class( new MovimientoCajaCtaCteGridModel() );
	}
