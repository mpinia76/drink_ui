<?php
namespace Drink\UI\pages\proveedors;

use Drink\UI\pages\DrinkPage;

use Drink\UI\components\filter\model\UIProveedorCriteria;

use Drink\UI\components\grid\model\ProveedorGridModel;

use Drink\UI\service\UIProveedorService;
 ...
 * 
 */
class Proveedors extends DrinkPage{
