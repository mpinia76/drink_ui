...
use Drink\UI\components\filter\model\UIMovimientoVentaCriteria;

use Drink\UI\components\grid\model\MovimientoVentaGridModel;
 ...
 * 
 */
class MovimientosVenta extends DrinkPage{
