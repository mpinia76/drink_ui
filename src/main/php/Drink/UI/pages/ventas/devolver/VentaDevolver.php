<?php
namespace Drink\UI\pages\ventas\devolver;
...
class VentaDevolver extends DrinkPage{
...
//
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		DrinkUIUtils::setDevolucionesVentaSession( array() );
        ...
        $oVendedor = $this->getVenta()->getVendedor();
