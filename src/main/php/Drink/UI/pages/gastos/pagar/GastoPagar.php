<?php
namespace Drink\UI\pages\gastos\pagar;
...
class GastoPagar extends DrinkPage{
...
//		
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "lbl_pendiente", $this->localize( "forma.pago.pendiente") );
			...
			$xtpl->assign( "linkPagarEfectivo", $this->getLinkActionPagarGasto($this->getGasto(), DrinkUtils::getCuentaUnica(), $this->getBackTo()) );
