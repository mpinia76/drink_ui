...
class AdminMovimientos extends DrinkPage{
	...
	public function parseSaldos(XTemplate $xtpl){
			...
			$xtpl->assign("saldo_ganancias", DrinkUIUtils::formatMontoToView( UIServiceFactory::getUIVentaService()->getGanancias($criteria)) );
			...
			$xtpl->assign("saldo_pedidos", DrinkUIUtils::formatMontoToView( UIServiceFactory::getUIMovimientoPedidoService()->getTotalesDia(new Datetime())) );
