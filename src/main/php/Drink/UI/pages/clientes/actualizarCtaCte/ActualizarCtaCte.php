<?php
namespace Drink\UI\pages\clientes\actualizarCtaCte;


use Drink\UI\service\finder\ClienteFinder;

use Drink\UI\service\finder\CuentaFinder;
...
class ActualizarCtaCte extends DrinkPage{
	...
	public function __construct(){
		...
		/*if( DrinkUIUtils::isCajaSelected() )
			$this->destino = DrinkUIUtils::getCaja();*/
