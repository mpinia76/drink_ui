...
namespace Drink\UI\components\boxes\presupuesto;
...
class PresupuestoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", DrinkUIUtils::formatMontoToView( $this->getPresupuesto()->getMonto() ) );
		
		
		
		$xtpl->assign( "observaciones", $this->getPresupuesto()->getObservaciones() );
		$xtpl->assign( "fecha", DrinkUIUtils::formatDateTimeToView($this->getPresupuesto()->getFecha()) );
		...
		$xtpl->assign( "total", DrinkUIUtils::formatMontoToView( $presupuesto->getMonto() ) );
