...
use Drink\UI\components\grid\formats\GridPrecioListaFormat;
use Drink\UI\components\grid\formats\GridPrecioEfectivoFormat;
use Drink\UI\components\grid\formats\GridPorcentajeFormat;
...
//		//TODO esto setearlo en el .rasty
	...
	protected function initModel() {
		...
		$column = GridModelBuilder::buildColumn( "codigo", "producto.codigo", 20, EntityGrid::TEXT_ALIGN_RIGHT );
		$this->addColumn( $column );
		...
		$column = GridModelBuilder::buildColumn( "vencimiento", "producto.vencimiento", 20, EntityGrid::TEXT_ALIGN_CENTER, new GridDatetimeFormat("d/m/Y") );
		$this->addColumn( $column );
	...
	public function getMenuGroups( $item ){
		...
		$menuOption = new MenuOption();
		$menuOption->setLabel( $this->localize( "menu.productos.packs") );
	...
	public function getHeaderContent(){
		...
		return 'Total: '.DrinkUIUtils::formatMontoToView($service->getTotales($filter->getCriteria()));
	}
