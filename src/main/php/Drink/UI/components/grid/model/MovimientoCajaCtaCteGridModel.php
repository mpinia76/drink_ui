 ...
 * @since 07/04/2018
 */
class MovimientoCajaCtaCteGridModel extends EntityGridModel{
...
//    	
	    ...
	    $componentConfig->setId( "movimientoCajaCtaCtesfilter" );
		$componentConfig->setType( "MovimientoCajaCtaCteFilter" );
//		
...
//		
	...
	public function getHeaderContent(){
		...
		return '<strong>Saldo: '.DrinkUIUtils::formatMontoToView($this->getService()->getTotalesCuentas($criteria)).'</strong> ';
	}
