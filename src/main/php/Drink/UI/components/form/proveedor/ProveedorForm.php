...
namespace Drink\UI\components\form\proveedor;

use Drink\UI\components\filter\model\UIProveedorCriteria;

use Drink\UI\service\finder\ProveedorFinder;
...
use Drink\Core\model\CondicionIva;
...
class ProveedorForm extends Form{
	...
	public function getCondicionesIva(){
		...
		return DrinkUIUtils::localizeEntities(CondicionIva::getItems());
	}
