...
namespace Drink\UI\components\form\cliente;
...
use Drink\Core\model\Sexo;

use Drink\Core\model\TipoDocumento;
use Drink\Core\model\TipoCliente;
...
class ClienteForm extends Form{
	...
	public function getSexos(){
		...
		return DrinkUIUtils::localizeEntities(Sexo::getItems());
	}

	public function getTiposDocumento(){

		return DrinkUIUtils::localizeEntities(TipoDocumento::getItems());
	}

	public function getTiposCliente(){

		return DrinkUIUtils::localizeEntities(TipoCliente::getItems());
	}
