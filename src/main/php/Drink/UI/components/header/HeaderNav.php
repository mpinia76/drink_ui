...
namespace Drink\UI\components\header;
...
//			$menuGroups[] = $menuOption;
	...
	public function getMenuReportes(){
        ...
        $menuOption = new MenuOption();
        $menuOption->setLabel( $this->localize( "menu.pedidos") );
        $menuOption->setPageName( "BalancePedidos" );
        $menuOption->setIconClass( "icon-stats" );
        $menuGroupStats->addMenuOption( $menuOption );

        $menuOption = new MenuOption();
        $menuOption->setLabel( $this->localize( "menu.balances.rankclientes") );
        $menuOption->setPageName( "BalanceRankCliente" );
        $menuOption->setIconClass( "icon-stats" );
        $menuGroupStats->addMenuOption( $menuOption );

        $menuOption = new MenuOption();
        $menuOption->setLabel( $this->localize( "menu.balances.rankproductos") );
        $menuOption->setPageName( "BalanceRankProducto" );
        $menuOption->setIconClass( "icon-stats" );
        $menuGroupStats->addMenuOption( $menuOption );
